    ...
    MyForm() {
        ...
        const handleSubmit = (event) => {
            ...
            fetch('http://127.0.0.1:5000//api/data', {
                ...
                //.then(sortedData => console.log(sortedData[0]))
                .then(responseData => setRes(responseData[0]));
        ...
        return (
            <form onSubmit={handleSubmit}>
              ...
              <div>DrugID: {res.DrugID}</div>
              <div>DrugName:{res.Drug_name}</div>
              <div>Indication:{res.Indication}</div>
              <div>Product:{res.Product}</div>
              <div>Food_interaction:{res.Food_interaction}</div>
              <div>Drug_interaction:{res.Drug_interaction}</div>
          </form>
            /*<div>
                {handleSubmit}
            </div>*/
